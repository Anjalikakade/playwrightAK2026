...
//workbook ->worksheet->rows and coloumn 
const Path ="Utils/input.xlsx"; 
const workbook = xlsx.readFile(Path)
const allsheet = workbook.SheetNames[0]
const worksheet = workbook.Sheets[allsheet];
const dataset:any =xlsx.utils.sheet_to_json(worksheet)
